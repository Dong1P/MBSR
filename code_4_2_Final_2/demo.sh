...
python main.py --scale 4 --data_test MyImage --test_only --save_results --pre_train_1 ../experiment/EDSR_mild_Final_x4_2_0320_retrain/model/model_90.pt   --self_ensemble
