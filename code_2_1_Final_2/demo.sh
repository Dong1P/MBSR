...
#python main.py --model EDSR --scale 2 --save EDSR_mild_Final_x2_1_0320_retrain_update  --reset  --pre_train_1 ../experiment/EDSR_mild_Final_x2_1_0320_retrain/model/model_14.pt
...
python main.py --scale 2 --data_test MyImage --test_only --save_results --pre_train_1 ../experiment/EDSR_mild_Final_x2_1_0320_retrain_update/model/model_14.pt  --self_ensemble
