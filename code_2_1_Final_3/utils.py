...
class checkpoint():
    ...
    def save_results(self, idx, input, output, target, scale):
        if self.args.save_results:
            ...
            dir = '/home/kky/Dongwon/SuperResolution/Data/NTIRE/DIV2K/DIV2K_train_difficult/test_results'
#'/home/kky/Dongwon/SuperResolution/Data/NTIRE/DIV2K/DIV2K_train_LR_bicubic/X2_1_Final'

            filename = '%s/%04dx%d'%(dir, idx + 901, scale)
